function Create(self)
	...
	self.reflectionOutdoorsSound = CreateSoundContainer("ReflectionOutdoors AN-Mag", "SPF.rte");
	
	self.reloadPrepareSounds = {}
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare AN-Mag", "SPF.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare AN-Mag", "SPF.rte");
	...
	self.reloadPrepareLengths.MagIn = 190
	...
	self.reloadPrepareDelay.MagIn = 850
	self.reloadPrepareDelay.BoltBack = 200
	self.reloadPrepareDelay.BoltForward = 100
	
	self.reloadAfterSounds = {}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut AN-Mag", "SPF.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn AN-Mag", "SPF.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack AN-Mag", "SPF.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward AN-Mag", "SPF.rte");
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.afterSoundPlayed ~= true then
				...
				if self.reloadPhase == 0 then
					self.phaseOnStop = 1;
					local fake
					fake = CreateMOSRotating("Fake Magazine MOSRotating AN-Mag");
					fake.Pos = self.Pos + Vector(0 * self.FlipFactor, 3):RadRotate(self.RotAngle);
