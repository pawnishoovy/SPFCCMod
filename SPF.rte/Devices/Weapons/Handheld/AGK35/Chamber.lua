function Create(self)
	...
	self.preSound = CreateSoundContainer("Pre AGK35", "SPF.rte");
	self.reflectionOutdoorsSound = CreateSoundContainer("ReflectionOutdoors AGK35", "SPF.rte");
	
	self.reloadPrepareSounds = {}
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare AGK35", "SPF.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare AGK35", "SPF.rte");
	self.reloadPrepareSounds.BoltBack = nil;
	self.reloadPrepareSounds.BoltForward = nil;
	
	self.reloadPrepareLengths = {}
	self.reloadPrepareLengths.MagOut = 240
	self.reloadPrepareLengths.MagIn = 130
	self.reloadPrepareLengths.BoltBack = 0
	self.reloadPrepareLengths.BoltForward = 0
	
	self.reloadPrepareDelay = {}
	self.reloadPrepareDelay.MagOut = 450
	self.reloadPrepareDelay.MagIn = 750
	self.reloadPrepareDelay.BoltBack = 200
	self.reloadPrepareDelay.BoltForward = 100
	
	self.reloadAfterSounds = {}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut AGK35", "SPF.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn AGK35", "SPF.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack AGK35", "SPF.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward AGK35", "SPF.rte");
	
	self.reloadAfterDelay = {}
	self.reloadAfterDelay.MagOut = 700
	self.reloadAfterDelay.MagIn = 250
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.afterSoundPlayed ~= true then
				...
				if self.reloadPhase == 0 then
					self.phaseOnStop = 1;
					local fake
					fake = CreateMOSRotating("Fake Magazine MOSRotating AGK35");
