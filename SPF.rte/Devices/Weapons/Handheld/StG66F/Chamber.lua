function Create(self)
	...
	self.reflectionOutdoorsSound = CreateSoundContainer("ReflectionOutdoors StG 66-F", "SPF.rte");
	
	self.reloadPrepareSounds = {}
	self.reloadPrepareSounds.BoltBack = nil
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare StG 66-F", "SPF.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare StG 66-F", "SPF.rte");
	self.reloadPrepareSounds.BoltForward = nil
	
	self.reloadPrepareLengths = {}
	self.reloadPrepareLengths.BoltBack = 0
	self.reloadPrepareLengths.MagOut = 55
	self.reloadPrepareLengths.MagIn = 175
	self.reloadPrepareLengths.BoltForward = 0
	
	self.reloadPrepareDelay = {}
	self.reloadPrepareDelay.BoltBack = 275
	self.reloadPrepareDelay.MagOut = 250
	self.reloadPrepareDelay.MagIn = 1000
	self.reloadPrepareDelay.BoltForward = 70
	
	self.reloadAfterSounds = {}
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack StG 66-F", "SPF.rte");
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut StG 66-F", "SPF.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn StG 66-F", "SPF.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward StG 66-F", "SPF.rte");
	
	self.reloadAfterDelay = {}
	self.reloadAfterDelay.BoltBack = 175
	self.reloadAfterDelay.MagOut = 400
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.afterSoundPlayed ~= true then
				...
				if self.reloadPhase == 0 then
					self.phaseOnStop = 1;
					local fake
					fake = CreateMOSRotating("Fake Magazine MOSRotating StG 66-F");
