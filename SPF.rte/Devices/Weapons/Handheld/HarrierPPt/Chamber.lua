function Create(self)
	...
	self.preSound = CreateSoundContainer("Pre Harrier PPt", "SPF.rte");
	self.reflectionOutdoorsSound = CreateSoundContainer("ReflectionOutdoors Harrier PPt", "SPF.rte");
	
	self.reloadPrepareSounds = {}
	self.reloadPrepareSounds.MagOut = CreateSoundContainer("MagOutPrepare Harrier PPt", "SPF.rte");
	self.reloadPrepareSounds.MagIn = CreateSoundContainer("MagInPrepare Harrier PPt", "SPF.rte");
	self.reloadPrepareSounds.BoltBack = nil;
	self.reloadPrepareSounds.BoltForward = nil;
	
	self.reloadPrepareLengths = {}
	self.reloadPrepareLengths.MagOut = 100
	self.reloadPrepareLengths.MagIn = 50
	self.reloadPrepareLengths.BoltBack = 0
	self.reloadPrepareLengths.BoltForward = 0
	
	self.reloadPrepareDelay = {}
	self.reloadPrepareDelay.MagOut = 350
	self.reloadPrepareDelay.MagIn = 440
	self.reloadPrepareDelay.BoltBack = 400
	self.reloadPrepareDelay.BoltForward = 110
	
	self.reloadAfterSounds = {}
	self.reloadAfterSounds.MagOut = CreateSoundContainer("MagOut Harrier PPt", "SPF.rte");
	self.reloadAfterSounds.MagIn = CreateSoundContainer("MagIn Harrier PPt", "SPF.rte");
	self.reloadAfterSounds.BoltBack = CreateSoundContainer("BoltBack Harrier PPt", "SPF.rte");
	self.reloadAfterSounds.BoltForward = CreateSoundContainer("BoltForward Harrier PPt", "SPF.rte");
	
	self.reloadAfterDelay = {}
	self.reloadAfterDelay.MagOut = 440
	self.reloadAfterDelay.MagIn = 440
	self.reloadAfterDelay.BoltBack = 200
	self.reloadAfterDelay.BoltForward = 110
		...
		if self.reloadTimer:IsPastSimMS(self.reloadDelay) then
			...
			if self.afterSoundPlayed ~= true then
				...
				if self.reloadPhase == 0 then
					self.phaseOnStop = 1;
					local fake
					fake = CreateMOSRotating("Fake Magazine MOSRotating Harrier PPt");
