function Create(self)
	...
	self.landSound = self.PresetName == "Armoured Federal Privateer" and CreateSoundContainer("SPF Infantry LandHeavy", "SPF.rte") or CreateSoundContainer("SPF Infantry LandLight", "SPF.rte");
